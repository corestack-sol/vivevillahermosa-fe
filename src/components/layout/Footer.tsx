          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <span className="flex items-center gap-2 text-sm text-white/70">
                ...
                <MapPin size={14} className="text-[#FF4D4D] flex-shrink-0" /> Villahermosa, Tabasco, México
              </span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 p-3 bg-white/10 rounded-xl flex items-start gap-3">
              ...
              <p className="text-xs text-white/70 leading-relaxed">
                ...
                En Tabasco las lluvias importan. Por eso cada propiedad muestra su historial de inundación: oficial en Centro, indicado por quien publica en el resto. Solo en Vive Villahermosa.
              </p>
            </div>
          </div>
        </div>
