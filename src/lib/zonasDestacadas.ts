...
export const ZONAS_DESTACADAS: ZonaDestacada[] = [
  ...
  },
  {
    ...
    categoria: 'plusvalia-alta',
    descripcion: 'Cerca de Plaza Altabrisa, con vivienda residencial de nivel alto.',
  ...
  },
  {
    ...
    categoria: 'plusvalia-alta',
    descripcion: 'Zona exclusiva y segura, con vigilancia privada, clubes deportivos y colegios privados cercanos.',
  ...
  },
  {
    ...
    categoria: 'plusvalia-alta',
    descripcion: 'Zona cerca del Hospital General del ISSSTE y el Aeropuerto Internacional.',
  ...
  },
  {
    ...
    label: 'Paseo Tabasco',
    categoria: 'plusvalia-alta',
    descripcion: 'Eje vial que concentra desarrollo habitacional vertical y edificios corporativos.',
  ...
  },
  {
    ...
    label: 'Lindavista',
    categoria: 'plusvalia-alta',
    descripcion: 'Colonia cerca de Paseo Tabasco, con centros educativos y médicos cercanos.',
  ...
  },
  {
    ...
    descripcion: 'Nodo logístico y comercial de la Chontalpa, conocida como la "Puerta del Sureste", cerca de la Universidad Popular de la Chontalpa.',
  ...
  },
  {
    ...
    descripcion: 'Ciudad dormitorio conectada a Villahermosa, con vivienda económica y media-baja.',
  ...
  },
  {
    ...
    descripcion: 'Zona cerca de la Ciudad Industrial y el periférico, con vivienda a precios competitivos para trabajadores del sector industrial.',
