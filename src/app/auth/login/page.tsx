      ...
      <div className="w-full max-w-sm lg:max-w-5xl bg-white rounded-2xl shadow-xl overflow-hidden lg:flex">
        ...
        <div className="relative hidden lg:flex flex-col justify-between w-[460px] flex-shrink-0
          ...
          {/* Nube de puntos + constelación de fondo, tenue — ver
              src/components/brand/BrandParticles.tsx. Detrás de todo (z-0)
              y sin interacción (pointer-events-none). */}
          <BrandParticlesDynamic />

          <Link href="/" className="relative z-10 flex items-center gap-2.5">
            {/* Mismo logo real y mismo lockup que Navbar.tsx — antes esta
                card tenía un ícono de casa genérico y "VveVH" con un color
                (#F59E0B) que no era ni el acento de marca ni coincidía con
                el logo nuevo. */}
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/65 text-sm leading-relaxed mb-6">
              La plataforma inmobiliaria local con historial de inundación en cada propiedad.
            </p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link href="/auth/recuperar-password" className="text-xs font-semibold text-brand hover:underline">¿Olvidaste tu contraseña?</Link>
                </div>
