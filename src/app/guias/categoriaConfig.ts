import { Compass, Scale, Lightbulb, TrendingUp, ShieldAlert, type LucideIcon } from 'lucide-react';
...
export const CATEGORIA_CONFIG: Record<string, CategoriaVisual> = {
  ...
  Seguridad:   { Icon: ShieldAlert, from: 'var(--type-local-from)',       to: 'var(--type-local-to)',        accent: 'var(--type-local-accent)' },
};
